...
function Footer() {
  return (
    <div className="textFont text-white bg-[#013a19] mt-[40px] rounded-t-[50px] px-[16px] md:flex md:flex-row">
      <div>
        <img
          src={logo}
          alt="logo"
          className="w-[30vw] md:w-[10vw] md:h-[10vw] h-[30vw] m-[-20px] md:m-[-5px]"
        />

        <p className="mx-[16px] text-[12px] w-[70vw] md:w-[50vw] lg:w-[30vw]">
        ...
        <div className="my-[16px] flex flex-row w-[25vw] md:w-[15vw] lg:w-[10vw] justify-between mx-[16px]">
          <svg
            width="30px"
            height="30px"
            viewBox="0 -4 48 48"
      ...
      <div className="flex flex-row">
        <div className="m-[16px] bg-green-50 p-[16px] rounded-[20px] h-[170px] md:h-[200px] flex-col flex justify-between">
          <h3 className="text-[#292929] font-semibold text-[4vw] md:text-[3vw] lg:text-[2vw] headingFont">
            Company
          </h3>
        ...
        <div className="m-[16px] w-[30vw] md:w-[20vw] bg-green-50 p-[16px] rounded-[20px] h-[150px] md:h-[130px] flex-col flex justify-between">
          <h3 className="text-[#292929] font-semibold text-[4vw] md:text-[3vw] lg:text-[2vw] headingFont">
            Legal
          </h3>
